...
if ($marker.source.sha256 -ne '2773c199b3ff28ad5a72e33feb97201a9567a633f8466620084362fd9aae7474') {
...
Write-Host '[RUN] locating approved reference by SHA and building native 128px translation candidate...' -ForegroundColor Cyan
