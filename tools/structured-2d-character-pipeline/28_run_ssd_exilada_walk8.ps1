...
$prep = Start-Process -FilePath $Python -ArgumentList $prepArgs -WorkingDirectory $ModelTraining -NoNewWindow -Wait -PassThru
...
$infer = Start-Process -FilePath $Python -ArgumentList $inferArgs -WorkingDirectory $ModelTraining -NoNewWindow -Wait -PassThru
...
$review = Start-Process -FilePath $Python -ArgumentList $reviewArgs -WorkingDirectory $ModelTraining -NoNewWindow -Wait -PassThru
