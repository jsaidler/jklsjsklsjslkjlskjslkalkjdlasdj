...
static func create_kernel_0a(seed_value: int) -> WorldState:
    ...
    world.agents = {"asha_steward": {"species": "human", "culture_id": "asha_riverfolk", "faction_id": "asha_council", "role": "steward", "traits": {"caution": 0.72, "greed": 0.28, "loyalty": 0.80}}, "warden_captain": {"species": "human", "culture_id": "asha_riverfolk", "faction_id": "road_wardens", "role": "captain", "traits": {"courage": 0.75, "caution": 0.54, "loyalty": 0.83}}, "red_knife_chief": {"species": "human", "culture_id": "red_waste_clans", "faction_id": "red_knives", "role": "raider_chief", "traits": {"courage": 0.79, "greed": 0.72, "caution": 0.34}}}
    for faction_id in world.factions.keys(): world.faction_knowledge[faction_id] = []
    for agent_id in world.agents.keys(): world.agent_knowledge[agent_id] = []
